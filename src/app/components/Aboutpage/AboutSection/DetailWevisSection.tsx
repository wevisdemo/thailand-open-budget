...
function BullhornIcon() {
  return (
    ...
    >
      ...
      />
      <path
        d="M2 7.5C2 6.94772 2.44772 6.5 3 6.5H4V10.5H3C2.44772 10.5 2 10.0523 2 9.5V7.5Z"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinejoin="round"
      />
      <path
        d="M4 6.5L13 3.5V12.5L4 10.5"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M6 11V13C6 13.2761 6.22386 13.5 6.5 13.5H8"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M13 8.5C14.1046 8.5 15 7.60457 15 6.5C15 5.39543 14.1046 4.5 13 4.5"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  return (
    <section className="bg-white">
      <div className="content-container flex w-full flex-col gap-[48px] py-[64px]">
        ...
        <WevisIcon className="h-[40px] w-[132px] shrink-0" />
        ...
        <div className="text-text-01 flex w-full flex-col gap-[16px]">
          ...
          <div className="flex flex-col gap-[8px] text-[16px] leading-[22px]">
            <p>
              ...
              ภารกิจของเราคือการทำให้ประชาธิปไตยไทยเปิดเผย โปร่งใส
              และมีส่วนร่วมได้
            </p>
            <p>
              ทีมงานบางส่วนของ WeVis ได้ร่วมริเริ่มโครงการทดลอง ELECT (
              <a
              ...
              เกี่ยวกับการเลือกตั้ง ’62 จนเมื่อปี 2021
              ได้มีการปรับวิธีทำงานให้เป็นมากกว่าสื่อ และใช้ชื่อ WeVis
              เพื่อให้ครอบคลุมประเด็นทางการเมืองที่มากไปกว่าการเลือกตั้ง
            </p>
            <p>
              WeVis พัฒนาเครื่องมือในรูปแบบต่างๆ
              เพื่อเปิดเผยและสื่อสารข้อมูลของภาครัฐ
              ...
              มาตลอดหลายปี โดยเปิดพื้นที่ให้บุคคลและองค์กร ทั้งภาครัฐและเอกชน
              สามารถเข้ามามีส่วนร่วมในการพัฒนาแต่ละโปรเจกต์ได้
            </p>
          </div>
        </div>
        ...
        <div className="text-text-01 flex w-full flex-col gap-[16px]">
          ...
          <div className="flex flex-col gap-[8px] text-[16px] leading-[22px]">
            <p>
              ...
              และแสดงข้อมูลเกี่ยวกับสังคมการเมือง
              เปิดเผยผ่านแพลตฟอร์มที่สร้างขึ้น เพื่อให้ประชาชนสามารถมีส่วนร่วม
              ตัดสินใจ และแสดงความคิดเห็นบนพื้นฐานของข้อมูลที่เข้าถึง เข้าใจ
              และเข้าใช้ง่าย โดยเปิดเผยข้อมูลทั้งหมดเป็นข้อมูลเปิด (Open Data)
              และ Source Code ทั้งหมด ให้นำไปใช้ต่อได้เพื่อประโยชน์สาธารณะ
            </p>
            <p>
            ...
            <p>
              หนึ่งในความเชื่อของพวกเราคือ
              ประชาชนสามารถทำงานร่วมกับรัฐเพื่อพัฒนาสังคมให้ดีขึ้นได้
        ...
        <div className="text-text-01 flex w-full flex-col gap-[16px]">
          ...
          <p className="text-[16px] leading-[22px]">
            คุณสามารถเป็นส่วนหนึ่งในการพัฒนาเทคโนโลยีภาคประชาชน (Civic
            Technology) ร่วมกับเราได้ โดยแจ้งความประสงค์ร่วมพัฒนาโปรเจกต์
            ส่งความคิดเห็น เสนอไอเดีย แจ้งเปลี่ยน / อัปเดตข้อมูล
            หรือมีข้อสงสัยอยากสอบถาม ได้ทาง Feedback Form หรือ GitHub Repository
            ข้างล่างนี้ และสามารถติดตามผลงานของ WeVis ได้ทุกช่องทาง Social Media
          </p>
          <div className="flex w-full items-center gap-[10px]">
            <a
              className="bg-interactive-01 border-decorative-01 text-text-04 hover:bg-blue-70 flex h-[42px] shrink-0 items-center gap-[6px] border px-[15px] py-[9px] text-[12px] leading-[18px] font-medium whitespace-nowrap transition-colors"
              href="mailto:team@wevis.info"
            >
              พบข้อผิดพลาดหรือมีไอเดีย? บอกเราเลย
              <BullhornIcon />
            </a>
...
export default DetailWevisSection;
